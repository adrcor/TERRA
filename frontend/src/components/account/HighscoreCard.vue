<template>
    <button v-if="test" @click="onClick" class="flex flex-1 flex-col rounded-lg items-center py-4 bg-overlay bg-opacity-0 hover:bg-opacity-5 hover:text-opacity-100" :class="selected ? 'text-primary bg-opacity-5 text-opacity-100' : 'text-on-background text-opacity-60'">
